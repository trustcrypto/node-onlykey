...
ONLYKEY.connect(async function() {
    ...
    ONLYKEY.derive_public_key("Onlykey Rocks!", keyType, /*press_required*/ false, async function(err, key) {
        ONLYKEY.derive_shared_secret("Onlykey Rocks!", bob.epub, keyType, /*press_required*/ false, async function(err, sharedSecret) {
